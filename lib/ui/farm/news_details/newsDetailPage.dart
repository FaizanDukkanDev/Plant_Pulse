...
import 'package:plantpulse/ui/farm/news/bloc/bloc.dart';
        ...
        SliverToBoxAdapter(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(article.title, style: AppTheme.appTheme.textTheme.titleMedium),
              SizedBox(
                height: 10,
              ),
              Row(
                children: <Widget>[
                  Text(article.author ?? '', style: AppTheme.appTheme.textTheme.titleMedium!),
                  SizedBox(
                    width: 10,
                  ),
                  Text(article.getTime(), style: AppTheme.appTheme.textTheme.titleMedium!),
                ],
              ),
              Divider(
                height: 20,
              ...
              Text(article.content ?? '', style:AppTheme.appTheme.textTheme.titleMedium!)
            ],
          ),
        ))
      ],
